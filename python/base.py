...
from python.utils.array.nd import nd_split_slices, remove_margin_slice
from python.utils.log.log import lsection, lprint
from python.utils.normaliser.identity import IdentityNormaliser
from python.utils.normaliser.minmax import MinMaxNormaliser
from python.utils.normaliser.percentile import PercentileNormaliser
from python.utils.offcore.offcore import offcore_array
...
class ImageTranslatorBase(ABC):
    ...
    def __init__(
        ...
        :param monitor: monitor object, has to be instance of aydin.it.monitor.Monitor class
        """
